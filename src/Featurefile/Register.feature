Feature: Nopcommerce Registration
  ...
  Background: I am on Nopcommerce Registration page
    ...
    Then  I an on Nopcommerce Registration page
  ...
  Scenario Outline: I should not be able to register with invalid data on mandatory field (*) of registration page
    ...
    And   I enter Confiram Password "<Confiram Password>"
    And   Click on Register button
    Then  I can see an error message "<error message>
    And   I am not able to register

    Examples:
      | First Name | Last Name | Email            | Password | Confiram Password | error message                              |
  ...
  Scenario: I should be able to select andy one radio button from Gender Lable of your Personal Details section
    Given   I select "Male" radio button
